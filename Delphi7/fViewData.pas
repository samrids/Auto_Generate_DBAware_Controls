...
uses
  ...
  cxDropDownEdit, cxCalc, cxTextEdit, StdCtrls, ExtCtrls,

  ActnList, MemDS, DBAccess, DB,
...
type
  ...
  public
    ...
    property MultipleColumn: Boolean read FMultipleColumn write FMultipleColumn default True;
...
begin
  ...
  begin
    ...
    // ---
    else if (Query.Fields.Fields[i].DataType = DB.ftMemo) then
    begin
